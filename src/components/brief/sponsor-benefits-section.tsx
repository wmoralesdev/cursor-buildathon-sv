...
import { Briefcase, MonitorPlay, Network } from "lucide-react";
...
const BENEFIT_DEFS: BenefitDef[] = [
  {
    code: "01",
    Icon: Network,
    titleKey: "sponsorBenefits.b1.title",
    bodyKey: "sponsorBenefits.b1.body",
  },
  {
    code: "02",
    Icon: MonitorPlay,
    titleKey: "sponsorBenefits.b2.title",
    bodyKey: "sponsorBenefits.b2.body",
  },
  {
    code: "03",
    Icon: Briefcase,
    titleKey: "sponsorBenefits.b3.title",
    bodyKey: "sponsorBenefits.b3.body",
  },
];
...
export function SponsorBenefitsSection() {
  ...
  const benefits = useMemo(
    () => BENEFIT_DEFS.map((b) => ({ ...b, title: t(b.titleKey), body: t(b.bodyKey) })),
    [t],
  );
    ...
    >
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 lg:gap-20 items-start">
          {/* Left header column — sticky on lg so outcomes scroll past */}
          <div className="lg:col-span-5 reveal lg:sticky lg:top-24">
            <span className="tag mb-6 inline-block">{t("sponsorBenefits.tag")}</span>
          ...
          <ol className="lg:col-span-7 grid gap-3">
            ...
            {/* Inline CTA reinforcement */}
            <li className="reveal mt-3 flex flex-col gap-3 border-l-2 border-accent/40 pl-5 sm:pl-6">
              <p className="font-mono text-[0.65rem] tracking-[0.18em] uppercase text-accent">
                {t("sponsorBenefits.ctaLabel")}
              </p>
              <p className="font-display text-sm text-fg-2 leading-[1.7] max-w-[55ch]">
                {t("sponsorBenefits.ctaBody")}
              </p>
            </li>
          </ol>
        </div>
