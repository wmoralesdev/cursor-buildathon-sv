export const translations = {
  ...
  "nav.followCta": { en: "Follow updates →", es: "Seguir novedades →" },
  ...
  "notFound.kicker": { en: "Page not found", es: "Página no encontrada" },
  "notFound.title": { en: "This route does not exist", es: "Esta ruta no existe" },
  "notFound.body": {
    en: "The link may be outdated, mistyped, or only available in development. Head back to the event site or the welcome page.",
    es: "El enlace puede estar desactualizado, mal escrito o disponible solo en desarrollo. Vuelve al sitio del evento o a la página de bienvenida.",
  },
  "notFound.pathLabel": { en: "Requested path", es: "Ruta solicitada" },
  ...
  "about.profile1.desc": {
    en: "Builders on modern stacks who spend the window shipping working software with AI tooling.",
    es: "Builders con stack moderno que pasan la ventana entregando software funcional con herramientas de IA.",
  },
  "about.profile2.title": { en: "Product & design", es: "Producto y diseño" },
  "about.profile2.desc": {
    en: "Designers and product minds embedded with teams for 24 hours — shaping UX, flows, and demos.",
    es: "Diseñadores y perfiles de producto junto a los equipos durante 24 horas — UX, flujos y demos.",
  },
  "about.profile3.title": { en: "Founders & makers", es: "Founders y makers" },
  "about.profile3.desc": {
    en: "Entrepreneurs testing ideas fast and turning concepts into demos before the closing showcase.",
    es: "Emprendedores que prueban ideas rápido y convierten conceptos en demos antes del cierre.",
  },
  "about.profile4.title": { en: "Emerging talent", es: "Talento emergente" },
  "about.profile4.desc": {
    en: "University participants and early-career builders exploring AI-assisted code in a live event setting.",
    es: "Participantes universitarios y builders en etapa temprana explorando código asistido por IA en un evento en vivo.",
  },

  "eventStory.tag": { en: "// 02 — what to watch", es: "// 02 — qué seguir" },
  "eventStory.title1": { en: "Three moments", es: "Tres momentos" },
  "eventStory.title2": { en: "worth following", es: "que valen la pena" },
  "eventStory.intro": {
    en: "The buildathon is one continuous arc — not a two-day conference. These are the beats that define the event on the ground and online.",
    es: "El buildathon es un arco continuo — no una conferencia de dos días. Estos son los momentos que marcan el evento en sede y en línea.",
  },
  "eventStory.b1.title": { en: "The room", es: "La sala" },
  "eventStory.b1.body": {
    en: "~200 registered builders from El Salvador and Central America, gathered in person at UFG — concentrated energy in one place.",
    es: "~200 builders registrados de El Salvador y Centroamérica, reunidos en persona en la UFG — energía concentrada en un solo lugar.",
  },
  ...
  "eventStory.b3.body": {
    en: "Closing at 9:00 on July 5: demos, jury review, and the projects built during the window — the natural recap moment.",
    es: "Cierre a las 9:00 del 5 de julio: demos, revisión del jurado, y los proyectos construidos en la ventana — el momento natural de recap.",
  },
  "eventStory.cta": { en: "Follow event updates →", es: "Seguir novedades del evento →" },

  "sponsorsSection.tag": { en: "// 04 — partners", es: "// 04 — aliados" },
  "sponsorsSection.title1": { en: "Backed by", es: "Con el respaldo de" },
  "sponsorsSection.title2": { en: "our partners", es: "nuestros aliados" },
  "sponsorsSection.intro": {
    en: "Product partners supporting the buildathon with tools, credits, and community reach. Each partner has a home in this grid.",
    es: "Partners de producto que apoyan el buildathon con herramientas, créditos y alcance comunitario. Cada aliado tiene su espacio en esta grilla.",
  },
  "sponsorsSection.hostLabel": { en: "Presented by", es: "Presentado por" },

  "mentors.tag": { en: "// 05 — mentors", es: "// 05 — mentores" },
  "mentors.title1": { en: "Mentors on", es: "Mentores en" },
  "mentors.title2": { en: "the floor", es: "sede" },
  "mentors.aside": {
    en: "Advisors participants can connect with during the build window — online and on-site. Roster updates as confirmations land.",
    es: "Asesores con los que los participantes pueden conectar durante la ventana de build — en línea y en sede. El roster se actualiza conforme confirmamos.",
  },
  "mentors.placeholderName": { en: "Mentor TBA", es: "Mentor por confirmar" },

  "judges.tag": { en: "// 06 — jury", es: "// 06 — jurado" },
  "judges.title1": { en: "Judging", es: "Jurado" },
  "judges.title2": { en: "panel", es: "evaluador" },
  "judges.aside": {
    en: "The panel reviewing projects at closing. Names publish here as the jury is confirmed.",
  ...
  "people.aside": {
    en: "A Cursor Community event led by Ai /abs ambassadors, in partnership with UFG and a regional builder community of 500+.",
    es: "Un evento Cursor Community liderado por embajadores de Ai /abs, en alianza con la UFG y una comunidad regional de 500+ builders.",
  },
  ...
  "faq.tag": { en: "// 10 — answers", es: "// 10 — respuestas" },
  "faq.title1": { en: "Event", es: "Preguntas" },
  "faq.title2": { en: "FAQ", es: "frecuentes" },
  "faq.subtitle": {
    en: "Logistics, program, and how to follow or cover the buildathon.",
    es: "Logística, programa, y cómo seguir o cubrir el buildathon.",
  },
  "faq.toCta": { en: "Press inquiries →", es: "Consultas de prensa →" },
  "faq.q0": {
    en: "What is Cursor Buildathon El Salvador?",
  ...
  "faq.q1": {
    ...
    es: "¿Cuándo y dónde es?",
  },
  "faq.a1": {
    en: "July 4 at 8:00 through July 5 at 9:00, local El Salvador time. Universidad Francisco Gavidia (UFG), San Salvador.",
    es: "4 de julio 8:00 hasta 5 de julio 9:00, hora local de El Salvador. Universidad Francisco Gavidia (UFG), San Salvador.",
  },
  "faq.q2": {
    en: "Who is attending?",
    es: "¿Quiénes asisten?",
  ...
  "faq.a2": {
    en: "200 registered builders from El Salvador and Central America — developers, product and design profiles, founders, and university talent.",
    es: "200 builders registrados de El Salvador y Centroamérica — developers, perfiles de producto y diseño, founders, y talento universitario.",
  },
  "faq.q3": {
    en: "Who organizes it?",
    es: "¿Quién lo organiza?",
  },
  "faq.a3": {
    en: "Walter Morales and Daniela Huezo, Cursor Ambassadors and founders of Ai /abs, in partnership with UFG. See the Organizers section for bios and contact context.",
    es: "Walter Morales y Daniela Huezo, Cursor Ambassadors y fundadores de Ai /abs, en alianza con la UFG. Ver la sección Organizadores para bios y contexto de contacto.",
  },
  "faq.q4": {
    en: "Who are the mentors and judges?",
    es: "¿Quiénes son los mentores y jurados?",
  },
  "faq.a4": {
    en: "Mentors advise teams during the build window; judges review projects at closing. Both rosters publish on this page as names are confirmed — see Mentors and Judges sections.",
    es: "Los mentores asesoran equipos durante la ventana de build; el jurado evalúa proyectos en el cierre. Ambos rosters se publican en esta página conforme confirmamos nombres — ver secciones Mentores y Jurado.",
  },
  "faq.q5": {
    en: "Is registration still open?",
    es: "¿El registro sigue abierto?",
  },
  "faq.a5": {
    en: "No — all 200 spots are filled. Follow Ai /abs for event updates and live moments.",
    es: "No — los 200 cupos están llenos. Sigue a Ai /abs para novedades del evento y momentos en vivo.",
  },
  "faq.q6": {
    en: "What happens during the ~24 h window?",
    es: "¿Qué pasa durante la ventana de ~24 h?",
  },
  "faq.a6": {
    en: "Opening at 8:00 on July 4, then a continuous build block — teams ship with Cursor, connect with mentors, and prepare demos. Closing at 9:00 on July 5 with project showcase and jury review.",
    es: "Apertura a las 8:00 del 4 de julio, luego un bloque continuo de build — equipos construyen con Cursor, conectan con mentores, y preparan demos. Cierre a las 9:00 del 5 de julio con showcase de proyectos y revisión del jurado.",
  },
  "faq.q7": {
    en: "Where do accepted participants get logistics?",
    es: "¿Dónde obtienen logística los participantes aceptados?",
  },
  "faq.a7": {
    en: "Accepted participants use the welcome hub at /welcome for onboarding, share assets, and operational updates.",
    es: "Los participantes aceptados usan el hub de bienvenida en /welcome para onboarding, assets para compartir, y actualizaciones operativas.",
  },
  "faq.q8": {
    en: "How can creators cover or amplify the event?",
    es: "¿Cómo pueden creadores cubrir o amplificar el evento?",
  },
  "faq.a8": {
    en: "Follow Ai /abs for updates. On LinkedIn, mention Cursor, Ai /abs, Walter Morales, and Daniela Huezo. On X, tag @cursor, @wmoralesdev, and @irenehl__.",
    es: "Sigue a Ai /abs para novedades. En LinkedIn, menciona a Cursor, Ai /abs, Walter Morales, y Daniela Huezo. En X, etiqueta a @cursor, @wmoralesdev, y @irenehl__.",
  },
  "faq.q9": {
    en: "How do media reach organizers?",
    es: "¿Cómo contactan medios a los organizadores?",
  },
  "faq.a9": {
    en: "Email hello@wmorales.dev with subject line “Cursor Buildathon SV — Media” for interviews, on-site access, or fact-checking.",
    es: "Escribe a hello@wmorales.dev con asunto “Cursor Buildathon SV — Media” para entrevistas, acceso en sede, o verificación de datos.",
  },
  ...
  "overview.h4.title": { en: "In-person at UFG", es: "Presencial en UFG" },
  "overview.h4.body": {
    en: "Date, venue, and build window are set. The format concentrates regional builders in one room for a single continuous build arc.",
    es: "Fecha, sede y ventana del buildathon ya están definidas. El formato concentra builders regionales en una sala para un solo arco continuo de construcción.",
  },

  "details.tag": { en: "// 08 — logistics", es: "// 08 — logística" },
  "details.title": { en: "Where & when", es: "Dónde & cuándo" },
  "details.note": {
    en: "In-person event · 200 builders registered",
    es: "Evento presencial · 200 builders registrados",
  },
  ...
  "numbers.tag": { en: "// 07 — by the numbers", es: "// 07 — en cifras" },
  ...
  "numbers.s6.label": { en: "Registered", es: "Registrados" },
  ...
  "schedule.tag": { en: "// 09 — schedule", es: "// 09 — agenda" },
  ...
  "schedule.item1.desc": {
    en: "Official buildathon start at UFG (San Salvador). Opening remarks and teams begin building.",
    es: "Inicio oficial del buildathon en la UFG (San Salvador). Palabras de apertura y los equipos empiezan a construir.",
  },
  "schedule.item2.time": { en: "~24 h", es: "~24 h" },
  "schedule.item2.title": { en: "Build window", es: "Ventana de construcción" },
  "schedule.item2.desc": {
    en: "Continuous time to build with your team, connect with mentors, and shape working demos through the night.",
    es: "Tiempo continuo para construir con tu equipo, conectar con mentores, y dar forma a demos funcionales durante la noche.",
  },
  "schedule.item3.time": { en: "Jul 5", es: "5 jul" },
  "schedule.item3.title": { en: "Closing — 9:00", es: "Cierre — 9:00" },
  "schedule.item3.desc": {
    en: "End of the event window. Demos, closing remarks, jury review, and recap of projects built during the buildathon.",
    es: "Fin de la ventana del evento. Demos, palabras de cierre, revisión del jurado, y recap de los proyectos construidos durante el buildathon.",
  },

  "footer.ctaTag": { en: "// 11 — stay connected", es: "// 11 — mantente al día" },
  "footer.ctaTitle1": { en: "Follow the", es: "Sigue el" },
  "footer.ctaTitle2": { en: "buildathon", es: "buildathon" },
  "footer.ctaBody": {
    en: "Announcements, live moments, and community updates land on Ai /abs social channels. Follow for the latest from the room.",
    es: "Anuncios, momentos en vivo, y novedades de la comunidad llegan en los canales de Ai /abs. Sigue para lo último desde la sala.",
  },
  "footer.ctaPrimary": { en: "Follow updates →", es: "Seguir novedades →" },
  "footer.ctaSecondary": { en: "Read event FAQ →", es: "Leer preguntas frecuentes →" },
  ...
  "footer.pressLink": { en: "Press inquiries →", es: "Consultas de prensa →" },
  "footer.nav.audience": { en: "The event", es: "El evento" },
  "footer.nav.story": { en: "What to watch", es: "Qué seguir" },
  "footer.nav.credibility": { en: "Organizers", es: "Organizadores" },
  "footer.nav.mentors": { en: "Mentors", es: "Mentores" },
  "footer.nav.judges": { en: "Judges", es: "Jurado" },
  "footer.nav.sponsors": { en: "Partners", es: "Aliados" },
  ...
  "builder.nav.hub": { en: "My hub", es: "Mi hub" },
  ...
  "builder.submit.cta.goToHub": { en: "Go to my hub →", es: "Ir a mi hub →" },
  ...
  "hub.tag": { en: "// Builder hub", es: "// Hub builders" },
  "hub.title": { en: "Event-day workspace", es: "Espacio del día del evento" },
  "hub.intro": {
    en: "Sign in, form your team, track checkpoints, submit deliverables, book mentors, and reserve call booths.",
    es: "Inicia sesión, forma tu equipo, registra checkpoints, entrega materiales, reserva mentores y booths.",
  },
  "hub.setupRequired": {
  ...
  "hub.gettingStarted.kicker": { en: "// Your checklist", es: "// Tu checklist" },
  "hub.gettingStarted.title": { en: "What to do next", es: "Qué hacer ahora" },
  "hub.gettingStarted.progress": { en: "{done} of {total} done", es: "{done} de {total} listos" },
  "hub.gettingStarted.allDone": {
    en: "You're all set — keep your project and deliverables up to date until the deadline.",
    es: "Todo listo — mantén tu proyecto y entregables al día hasta la fecha límite.",
  },
  "hub.gettingStarted.done": { en: "Done", es: "Listo" },
  "hub.gettingStarted.next": { en: "Next up", es: "Siguiente" },
  "hub.gettingStarted.pending": { en: "Pending", es: "Pendiente" },
  "hub.gettingStarted.step.team": { en: "Create or join a team", es: "Crea o únete a un equipo" },
  "hub.gettingStarted.step.teamHint": {
    en: "Start in the team card: create your squad or join with an invite code from your captain.",
    es: "Empieza en la tarjeta de equipo: crea tu squad o únete con el código de invitación de tu capitán.",
  },
  "hub.gettingStarted.step.repo": { en: "Link GitHub repository", es: "Vincula repositorio de GitHub" },
  "hub.gettingStarted.step.repoHint": {
    en: "Right after forming your team, the captain must link your public repo — we start tracking commits and changes immediately.",
    es: "Justo después de formar el equipo, el capitán debe vincular el repo público — empezamos a rastrear commits y cambios de inmediato.",
  },
  "hub.gettingStarted.step.project": { en: "Save project details", es: "Guarda los detalles del proyecto" },
  "hub.gettingStarted.step.projectHint": {
    en: "Add your project name, live URL, and which sponsor tools you used.",
    es: "Agrega nombre del proyecto, URL en vivo y qué herramientas de sponsors usaron.",
  },
  "hub.gettingStarted.step.feedback": { en: "Complete sponsor feedback", es: "Completa feedback de sponsors" },
  "hub.gettingStarted.step.feedbackHint": {
    en: "Each teammate submits short feedback for the sponsor products your team used.",
    es: "Cada integrante envía feedback breve sobre los productos de sponsors que usaron.",
  },
  "hub.gettingStarted.step.deliverables": { en: "Submit final deliverables", es: "Envía entregables finales" },
  "hub.gettingStarted.step.deliverablesHint": {
    en: "Add slides and a Loom-style demo link, then submit the final package when feedback is complete.",
    es: "Agrega slides y un enlace de demo (Loom u similar), luego envía el paquete final cuando el feedback esté completo.",
  },
  "hub.openAdmin": { en: "Open admin", es: "Abrir admin" },
  "hub.convexConnecting": {
    en: "Connecting your session to the event backend…",
    es: "Conectando tu sesión al backend del evento…",
  },
  "hub.convexAuthPending": {
    en: "Backend connection pending",
    es: "Conexión al backend pendiente",
  },
  "hub.convexAuthPendingHint": {
    en: "Tap Reconnect to sign out, then sign back in with Google.",
    es: "Toca Reconectar para cerrar sesión y vuelve a entrar con Google.",
  },
  "hub.convexMissingTemplate": {
    en: "Clerk is missing the Convex JWT template. Open the link below, activate the integration, then use Reconnect.",
    es: "A Clerk le falta el template JWT de Convex. Abre el enlace abajo, activa la integración y usa Reconectar.",
  },
  "hub.convexSetupLink": {
    en: "Open Clerk Convex setup",
    es: "Abrir setup Clerk → Convex",
  },
  "hub.session.label": { en: "Signed in as", es: "Sesión iniciada como" },
  "hub.session.unknownUser": { en: "Builder", es: "Builder" },
  "hub.session.convexLoading": { en: "Connecting to backend…", es: "Conectando al backend…" },
  "hub.session.convexReady": { en: "Backend connected", es: "Backend conectado" },
  "hub.session.convexPending": { en: "Backend not connected", es: "Backend sin conectar" },
  "hub.session.signOut": { en: "Sign out", es: "Cerrar sesión" },
  "hub.session.reconnect": { en: "Reconnect", es: "Reconectar" },
  "hub.session.signInAgain": { en: "Sign in again", es: "Iniciar sesión de nuevo" },
  "hub.error.generic": { en: "Something went wrong. Try again.", es: "Algo salió mal. Intenta de nuevo." },
  "hub.error.serverValidation": {
    en: "Save failed on the server. Refresh the page and try again — if it persists, contact staff.",
    es: "Falló el guardado en el servidor. Recarga la página e intenta de nuevo — si persiste, avisa al staff.",
  },
  "hub.profileSyncFailed": {
    en: "We couldn't sync your profile. Sign out and sign in again, or add an email to your account.",
    es: "No pudimos sincronizar tu perfil. Cierra sesión e inicia de nuevo, o agrega un correo a tu cuenta.",
  },

  "hub.team.tag": { en: "// Team", es: "// Equipo" },
  "hub.team.title": { en: "Your team", es: "Tu equipo" },
  "hub.team.createName": { en: "Team name", es: "Nombre del equipo" },
  "hub.team.createPlaceholder": { en: "Team name", es: "Nombre del equipo" },
  "hub.team.createCta": { en: "Create team", es: "Crear equipo" },
  "hub.team.joinCode": { en: "Invite code", es: "Código de invitación" },
  "hub.team.joinCta": { en: "Join team", es: "Unirse al equipo" },
  "hub.team.inviteCode": { en: "Invite code", es: "Código de invitación" },
  "hub.team.shareHint": {
    en: "Share this code so teammates can join your team.",
    es: "Comparte este código para que tus compañeros se unan al equipo.",
  },
  "hub.team.copy": { en: "Copy code", es: "Copiar código" },
  "hub.team.copied": { en: "Copied", es: "Copiado" },
  "hub.team.members": { en: "Members", es: "Integrantes" },
  ...
  "hub.progress.checkpoints": { en: "Checkpoints", es: "Checkpoints" },
  "hub.progress.done": { en: "Done", es: "Listo" },
  "hub.progress.pending": { en: "Pending", es: "Pendiente" },
  "hub.progress.checkIn": { en: "Check in", es: "Registrar" },
  "hub.progress.updateCheckpoint": { en: "Update", es: "Actualizar" },
  ...
  "hub.progress.step.repo_linked": { en: "GitHub repo linked", es: "Repo de GitHub vinculado" },
  ...
  "hub.progress.step.deliverables_ready": { en: "Deliverables ready", es: "Entregables listos" },
  "hub.progress.step.feedback_complete": { en: "Sponsor feedback complete", es: "Feedback de sponsors completo" },
  "hub.progress.step.final_submitted": { en: "Final submission", es: "Envío final" },

  "hub.project.tag": { en: "// Project", es: "// Proyecto" },
  "hub.project.title": { en: "Project details", es: "Detalles del proyecto" },
  "hub.project.needTeam": { en: "Join or create a team first.", es: "Primero únete o crea un equipo." },
  "hub.progress.repoLinked": { en: "GitHub repo linked", es: "Repo de GitHub vinculado" },
  "hub.project.createIntro": {
    en: "Add your project name, description, and live URL. Your GitHub repo should already be linked above.",
    es: "Agrega nombre, descripción y URL en vivo. Tu repo de GitHub ya debe estar vinculado arriba.",
  },
  "hub.project.name": { en: "Project name", es: "Nombre del proyecto" },
  "hub.project.nameRequired": { en: "Project name *", es: "Nombre del proyecto *" },
  "hub.project.description": { en: "Description", es: "Descripción" },
  "hub.project.descriptionRequired": { en: "Description *", es: "Descripción *" },
  "hub.project.url": { en: "Live URL", es: "URL en vivo" },
  "hub.project.urlRequired": { en: "Live URL *", es: "URL en vivo *" },
  "hub.project.repo": { en: "Repository", es: "Repositorio" },
  "hub.project.repoHint": {
    en: "Link your repo in the GitHub tracking card first — only the captain can set or change it.",
    es: "Vincula tu repo primero en la tarjeta de seguimiento de GitHub — solo el capitán puede configurarlo o cambiarlo.",
  },
  "hub.project.repoLinkedHint": {
    en: "Linked from GitHub tracking — change it there if needed (captain only).",
    es: "Vinculado desde seguimiento de GitHub — cámbialo ahí si hace falta (solo capitán).",
  },
  "hub.project.sponsorsUsed": { en: "Credit partners used", es: "Partners de créditos usados" },
  "hub.project.sponsorsUsedHint": {
    en: "Select the tech sponsors whose credits or API access your team used during the buildathon.",
    es: "Selecciona los sponsors de tecnología cuyos créditos o acceso API usó tu equipo durante el buildathon.",
  },
  "hub.project.save": { en: "Save project", es: "Guardar proyecto" },
  "hub.project.saving": { en: "Saving…", es: "Guardando…" },
  "hub.project.saved": {
    en: "Project saved.",
    es: "Proyecto guardado.",
  },
  "hub.project.savedBadge": { en: "Saved", es: "Guardado" },
  "hub.project.edit": { en: "Edit project", es: "Editar proyecto" },
  "hub.project.cancelEdit": { en: "Cancel", es: "Cancelar" },
  "hub.project.noSponsorsSelected": {
    en: "No credit partners selected yet.",
    es: "Aún no seleccionaste partners de créditos.",
  },
  "hub.project.error.nameRequired": {
    en: "Enter a project name before saving.",
    es: "Escribe el nombre del proyecto antes de guardar.",
  },
  "hub.project.error.descriptionRequired": {
    en: "Enter a short project description.",
    es: "Escribe una descripción breve del proyecto.",
  },
  "hub.project.error.urlRequired": {
    en: "Enter a live URL (demo or landing page).",
    es: "Ingresa una URL en vivo (demo o landing).",
  },
  "hub.project.error.urlInvalid": {
    en: "Live URL must be a valid http(s) link.",
    es: "La URL en vivo debe ser un enlace http(s) válido.",
  },
  "hub.project.error.repoRequired": {
    en: "Link your GitHub repo in the tracking card above first.",
    es: "Primero vincula tu repo de GitHub en la tarjeta de seguimiento arriba.",
  },
  "hub.project.error.repoInvalid": {
    en: "Repository URL must be a valid link.",
    es: "La URL del repositorio debe ser un enlace válido.",
  },
  "hub.project.error.repoGithubOnly": {
    en: "Only public GitHub repository URLs are supported.",
    es: "Solo se aceptan URLs de repos públicos en GitHub.",
  },
  "hub.project.error.repoCaptainOnly": {
    en: "Only the team captain can link or change the repository.",
    es: "Solo el capitán del equipo puede vincular o cambiar el repositorio.",
  },

  "hub.repo.tag": { en: "// Repository", es: "// Repositorio" },
  "hub.repo.title": { en: "GitHub tracking", es: "Seguimiento de GitHub" },
  "hub.repo.subtitle": {
    en: "We monitor your public repo for commits during the event to ensure work started at the buildathon.",
    es: "Monitoreamos tu repo público para verificar que el trabajo empezó durante el buildathon.",
  },
  "hub.repo.empty.intro": {
    en: "Link your public GitHub repo as soon as your team is formed. We capture a baseline and track every commit during the event.",
    es: "Vincula tu repo público de GitHub en cuanto formes el equipo. Capturamos una línea base y rastreamos cada commit durante el evento.",
  },
  "hub.repo.empty.captainHint": {
    en: "Must be public on github.com. Tracking starts immediately after linking.",
    es: "Debe ser público en github.com. El seguimiento empieza al vincular.",
  },
  "hub.repo.empty.captainOnly": {
    en: "Ask your team captain to link the repository — only they can start GitHub tracking.",
    es: "Pide a tu capitán que vincule el repositorio — solo ellos pueden iniciar el seguimiento de GitHub.",
  },
  "hub.repo.linkCta": { en: "Link repository & start tracking", es: "Vincular repo e iniciar seguimiento" },
  "hub.repo.linking": { en: "Linking…", es: "Vinculando…" },
  "hub.repo.refresh": { en: "Refresh", es: "Actualizar" },
  "hub.repo.refreshing": { en: "Refreshing…", es: "Actualizando…" },
  "hub.repo.syncing": { en: "Syncing repository data…", es: "Sincronizando datos del repositorio…" },
  "hub.repo.syncPending": {
    en: "Sync pending — save your project or refresh in a moment.",
    es: "Sincronización pendiente — guarda tu proyecto o actualiza en un momento.",
  },
  "hub.repo.syncFailed": {
    en: "Sync failed — check that the repo is public and try refreshing.",
    es: "Falló la sincronización — verifica que el repo sea público e intenta actualizar.",
  },
  "hub.repo.lastSynced": { en: "Last synced {time}", es: "Última sync {time}" },
  "hub.repo.recentCommits": { en: "Recent commits", es: "Commits recientes" },
  "hub.repo.contributorsList": { en: "Contributors", es: "Colaboradores" },
  "hub.repo.checkpointSummaries": { en: "Activity by checkpoint", es: "Actividad por checkpoint" },
  "hub.repo.checkpointCommitCount": { en: "{count} commits", es: "{count} commits" },
  "hub.repo.checkpointContributors": { en: "Authors", es: "Autores" },
  "hub.repo.noFlags": { en: "No compliance flags.", es: "Sin alertas de cumplimiento." },
  "hub.repo.error.linkFirst": {
    en: "Link your GitHub repository first.",
    es: "Primero vincula tu repositorio de GitHub.",
  },
  "hub.repo.error.generic": {
    en: "Something went wrong. Try again.",
    es: "Algo salió mal. Inténtalo de nuevo.",
  },
  "hub.repo.error.refreshCooldownRemaining": {
    en: "Please wait {seconds}s before refreshing again.",
    es: "Espera {seconds}s antes de actualizar de nuevo.",
  },
  "hub.repo.metric.lastPush": { en: "Last push", es: "Último push" },
  "hub.repo.metric.eventCommits": { en: "Event commits", es: "Commits del evento" },
  "hub.repo.metric.beforeEventCommits": { en: "Before kickoff", es: "Antes del inicio" },
  "hub.repo.metric.contributors": { en: "Contributors", es: "Colaboradores" },
  "hub.repo.metric.unknown": { en: "—", es: "—" },
  "hub.repo.status.ok": { en: "Compliant", es: "Cumple" },
  "hub.repo.status.review": { en: "Review", es: "Revisión" },
  "hub.repo.status.violation": { en: "Flagged", es: "Alerta" },
  "hub.repo.status.unknown": { en: "Pending", es: "Pendiente" },
  "hub.repo.flag.repoCreatedBeforeEvent": {
    en: "Repository was created before the event started.",
    es: "El repositorio se creó antes de que empezara el evento.",
  },
  "hub.repo.flag.preEventCommits": {
    en: "Commits exist before kickoff — may indicate pre-built work.",
    es: "Hay commits antes del inicio — puede indicar trabajo previo.",
  },
  "hub.repo.flag.fork": {
    en: "Repository is a fork — review the starting point.",
    es: "El repositorio es un fork — revisa el punto de partida.",
  },
  "hub.repo.flag.largeInitialCommit": {
    en: "First event commit is unusually large.",
    es: "El primer commit del evento es inusualmente grande.",
  },
  "hub.repo.flag.noCommitsInWindow": {
    en: "No commits yet during the event window.",
    es: "Aún no hay commits durante la ventana del evento.",
  },
  "hub.repo.flag.forcePushDetected": {
    en: "Commit history changed since linking — possible force-push.",
    es: "El historial cambió desde que se vinculó — posible force-push.",
  },
  "hub.repo.flag.repoNotLinked": {
    en: "No repository linked yet.",
    es: "Aún no hay repositorio vinculado.",
  },
  "hub.repo.flag.unknown": { en: "Compliance note", es: "Nota de cumplimiento" },
  ...
  "hub.deliverables.videoShowcase": { en: "Video showcase URL", es: "URL del video showcase" },
  "hub.deliverables.videoShowcaseHint": {
    en: "Share a Loom, YouTube, Vimeo, or similar link to your demo walkthrough.",
    es: "Comparte un enlace de Loom, YouTube, Vimeo u otra herramienta con tu demo.",
  },
  "hub.deliverables.videoShowcasePlaceholder": {
    en: "https://www.loom.com/share/...",
    es: "https://www.loom.com/share/...",
  },
  "hub.deliverables.viewVideo": { en: "View current video", es: "Ver video actual" },
  "hub.deliverables.videoRequired": {
    en: "Add a video showcase link before submitting.",
    es: "Agrega un enlace de video showcase antes de enviar.",
  },
  ...
  "hub.deliverables.testUsersPlaceholder": {
    ...
    es: "Credenciales o instrucciones para que el jurado pruebe tu producto.",
  },
  "hub.deliverables.feedbackReady": {
    en: "All required sponsor feedback is complete.",
    es: "Todo el feedback requerido de sponsors está completo.",
  },
  "hub.deliverables.feedbackPending": {
    en: "Each teammate must submit sponsor feedback before final submission.",
    es: "Cada integrante debe enviar feedback de sponsors antes del envío final.",
  },
  "hub.deliverables.submitted": { en: "Final submission received.", es: "Envío final recibido." },
  "hub.deliverables.saveDraft": { en: "Save draft", es: "Guardar borrador" },
  "hub.deliverables.submitFinal": { en: "Submit final", es: "Enviar final" },

  "hub.feedback.tag": { en: "// Sponsor feedback", es: "// Feedback sponsors" },
  "hub.feedback.title": { en: "Your sponsor feedback", es: "Tu feedback de sponsors" },
  "hub.feedback.intro": {
    en: "Share your experience with each sponsor tool your project used.",
    es: "Comparte tu experiencia con cada herramienta de sponsor que usó tu proyecto.",
  },
  "hub.feedback.noneRequired": { en: "No sponsor feedback required yet.", es: "Aún no se requiere feedback de sponsors." },
  "hub.feedback.field": { en: "Feedback", es: "Feedback" },
  "hub.feedback.done": { en: "Submitted", es: "Enviado" },
  "hub.feedback.required": { en: "Required", es: "Requerido" },
  "hub.feedback.save": { en: "Save feedback", es: "Guardar feedback" },
  ...
  "hub.social.hint.x": {
    en: "Paste the post URL from x.com or twitter.com — must include /status/ and the post ID.",
    es: "Pega la URL de la publicación en x.com o twitter.com — debe incluir /status/ y el ID del post.",
  },
  "hub.social.hint.linkedin": {
    en: "Paste a LinkedIn post URL (/posts/..., /feed/update/..., /pulse/..., or lnkd.in). Profile links are not accepted.",
    es: "Pega la URL de una publicación de LinkedIn (/posts/..., /feed/update/..., /pulse/... o lnkd.in). No se aceptan perfiles.",
  },
  "hub.social.error.urlRequired": {
    en: "Enter a post URL.",
    es: "Ingresa la URL de la publicación.",
  },
  "hub.social.error.urlInvalid": {
    en: "Post URL must be a valid http(s) link.",
    es: "La URL debe ser un enlace http(s) válido.",
  },
  "hub.social.error.xHost": {
    en: "This link is not from X — use x.com or twitter.com.",
    es: "Este enlace no es de X — usa x.com o twitter.com.",
  },
  "hub.social.error.xPostPath": {
    en: "Use a post link with /status/... (not a profile or home page).",
    es: "Usa un enlace de publicación con /status/... (no un perfil ni la página principal).",
  },
  "hub.social.error.linkedinHost": {
    en: "This link is not from LinkedIn — use linkedin.com or lnkd.in.",
    es: "Este enlace no es de LinkedIn — usa linkedin.com o lnkd.in.",
  },
  "hub.social.error.linkedinProfile": {
    en: "Profile links are not allowed — paste the URL of the post itself.",
    es: "No se permiten enlaces de perfil — pega la URL de la publicación.",
  },
  "hub.social.error.linkedinPostPath": {
    en: "Use a LinkedIn post URL (/posts/..., /feed/update/..., /pulse/..., or lnkd.in).",
    es: "Usa una URL de publicación de LinkedIn (/posts/..., /feed/update/..., /pulse/... o lnkd.in).",
  },

  "hub.mentors.tag": { en: "// Mentors", es: "// Mentores" },
  "hub.mentors.title": { en: "Remote mentors", es: "Mentores remotos" },
  "hub.mentors.intro": {
    en: "Book a call with mentors joining remotely.",
    es: "Reserva una llamada con mentores que se unen de forma remota.",
  },
  "hub.mentors.book": { en: "Book a call", es: "Reservar llamada" },
  "hub.mentors.noBooking": { en: "Booking link coming soon", es: "Enlace de reserva próximamente" },
