export const translations = {
  ...
  "hero.tldr.label": { en: "TL;DR", es: "En resumen" },
  "hero.tldr.aria": { en: "Event summary", es: "Resumen del evento" },
  "hero.tldr.item1": {
    en: "~24h AI buildathon at UFG, San Salvador — 2nd edition, Jul 4–5, 2026.",
    es: "Buildathon de IA ~24 h en la UFG, San Salvador — 2.ª edición, 4–5 jul 2026.",
  },
  "hero.tldr.item2": {
    en: "~200 AI-native builders on-site — devs, product, founders, university talent from Central America.",
    es: "~200 builders AI-native en sala — devs, producto, founders y talento universitario de Centroamérica.",
  },
  "hero.tldr.item3": {
    en: "Sponsors get logo presence, in-room product trials, stage/workshop slots, and hiring access.",
    es: "Sponsors obtienen logo en sitio, prueba de producto en sala, espacio en stage/talleres y acceso a hiring.",
  },
  "hero.tldr.item4": {
    en: "Product and cash tiers open — Codex, ElevenLabs, Netlify, and more already onboard.",
    es: "Tiers de producto y cash abiertos — Codex, ElevenLabs, Netlify y más ya a bordo.",
  },
  "hero.pitch": {
