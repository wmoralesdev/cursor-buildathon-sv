...
/** Dark base — same as export poster bg; only blob tints differ for `remotion:studio:bg`. */
const WELCOME_BACKGROUND_LOOP_BASE = "#14120b";
...
export const WelcomeBackgroundLoopBackground = memo(
  function WelcomeBackgroundLoopBackground({
    progressSeconds,
    className = "",
  }: Props) {
    ...
    return (
      <div
        ...
        style={{ background: WELCOME_BACKGROUND_LOOP_BASE, contain: "paint" }}
        aria-hidden
      >
        <div
          style={{
